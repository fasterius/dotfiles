...
if version >= 508 || !exists("did_python_syn_inits")
  ...
  if !s:Enabled("g:python_highlight_file_headers_as_comments")
    ...
    HiLink pythonRun              Comment       " Modified
  endif
  ...
  if s:Python2Syntax()
    ...
    HiLink pythonBytesEscape        Todo        " Modified
    HiLink pythonBytesEscapeError   Error
  endif

  HiLink pythonStrFormatting    PreProc         " Modified
  HiLink pythonStrFormat        PreProc         " Modified
  HiLink pythonStrTemplate      PreProc         " Modified

  HiLink pythonDocTest          Special
  HiLink pythonDocTest2         Special

  HiLink pythonNumber           Underlined      " Modified
  HiLink pythonHexNumber        Underlined      " Modified
  HiLink pythonOctNumber        Underlined      " Modified
  HiLink pythonBinNumber        Underlined      " Modified
  HiLink pythonFloat            Underlined      " Modified
  HiLink pythonNumberError      Error
  HiLink pythonOctError         Error
  HiLink pythonHexError         Error
  HiLink pythonBinError         Error

  HiLink pythonBoolean          Type            " Modified
